...
public class RabbitMQHeadersConfig {
    ...
    public Binding binding01() {
        ...
        map.put("color", "red");
        map.put("speed", "low");
        return BindingBuilder.bind(queue01()).to(headersExchange()).whereAny(map).match();// 满足一个键值对即可
    }
    ...
    public Binding binding02() {
        ...
        map.put("color", "red");
        map.put("speed", "fast");
        return BindingBuilder.bind(queue02()).to(headersExchange()).whereAll(map).match();// 需要满足所有键值对
    }
}
